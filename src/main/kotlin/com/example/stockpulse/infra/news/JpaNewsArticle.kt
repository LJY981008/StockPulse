...
data class JpaNewsArticle(
    ...
    companion object {
        fun JpaNewsArticle.toNewsArticle(company: Company, dataSource: DataSource): NewsArticle {
            return NewsArticle(
        ...
        fun NewsArticle.toJpaNewsArticle(jpaCompany: JpaCompany, jpaDataSource: JpaDataSource): JpaNewsArticle {
